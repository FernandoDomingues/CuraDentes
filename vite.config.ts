...
export default defineConfig({
  server: {
    ...
    headers: {
      ...
      "Content-Security-Policy": "default-src 'self'; script-src 'self' 'unsafe-inline' https://accounts.google.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://lh3.googleusercontent.com; connect-src 'self' https:; font-src 'self' https://fonts.gstatic.com; object-src 'none'; frame-ancestors 'none'; base-uri 'self'; worker-src 'self' blob:; frame-src 'self' https://accounts.google.com https://busca-profissionais.cfo.org.br;",
