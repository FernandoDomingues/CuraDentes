...
export const ESPECIALIDADES_SEO: Record<string, EspecialidadeSEO> = {
  "Clínico Geral": {
    ...
    description: "Encontre o melhor dentista clínico geral perto de você. Consultas de rotina, restaurações, limpeza e prevenção com profissionais qualificados.",
    keywords: ["dentista clínico geral", "consulta odontológica", "dentista perto de mim", "clínico geral dentista", "prevenção oral"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/clinico-geral.webp",
    introducao: "O clínico geral é o profissional responsável pelo primeiro contato do paciente com a odontologia. Realiza diagnósticos, prevenção, restaurações e encaminhamentos para especialistas quando necessário. É a porta de entrada para a saúde bucal.",
    topicos: [
  ...
  "Clareamento dental": {
    ...
    description: "Faça clareamento dental com profissionais confiáveis. Compare preços, veja avaliações e agende seu procedimento estético.",
    keywords: ["clareamento dental", "clareamento dentes", "branqueamento dental", "clareamento a laser", "clareamento caseiro"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/clareamento-dental.webp",
    introducao: "O clareamento dental é um dos procedimentos estéticos mais procurados na odontologia. Devolve o branco natural dos dentes removendo manchas causadas por alimentos, bebidas, tabaco e envelhecimento.",
    topicos: [
  ...
  "Lentes de contato dental": {
    ...
    description: "Lentes de contato dental para um sorriso perfeito. Encontre especialistas em lentes de porcelana, compare preços e avaliações.",
    keywords: ["lentes de contato dental", "lentes de porcelana", "facetas", "lentes dentais", "sorriso perfeito"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/lentes-de-contato-dental.webp",
    introducao: "As lentes de contato dental são finíssimas lâminas de porcelana ou resina que cobrem a parte frontal dos dentes, corrigindo imperfeições estéticas como manchas, desalinhamentos leves, diastemas e formatos irregulares.",
    topicos: [
  ...
  "Facetas de porcelana": {
    ...
    title: "Facetas de Porcelana | Preços e Especialistas | CuraDentes",
    description: "Facetas de porcelana para um sorriso renovado. Encontre dentistas especializados, veja fotos de antes e depois e agende sua consulta.",
    keywords: ["facetas de porcelana", "facetas dentais", "porcelana nos dentes", "sorriso novo", "restauração estética"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/lentes-de-contato-dental.webp",
    introducao: "As facetas de porcelana são capas finas que recobrem a face frontal dos dentes, restaurando a estética do sorriso em casos de dentes escurecidos, fraturados, desgastados ou com formato irregular.",
    topicos: [
      { titulo: "Vantagens da porcelana", texto: "A porcelana é um material biocompatível, resistente a manchas e com aparência muito semelhante ao esmalte natural do dente, proporcionando um resultado estético superior." },
      { titulo: "Processo de aplicação", texto: "São necessárias 2 a 3 sessões. O dentista prepara os dentes com desgaste mínimo, faz a moldagem digital ou convencional, e na consulta seguinte cimenta as facetas definitivas." },
      { titulo: "Manutenção e cuidados", texto: "A higiene deve ser rigorosa, com escovação e fio dental diários. Consultas de retorno a cada 6 meses para avaliação e polimento profissional." },
    ],
    beneficios: [
      "Corrige manchas profundas que não respondem ao clareamento",
      "Restaura dentes fraturados ou desgastados",
      "Alta resistência e durabilidade (12 a 15 anos)",
      "Aparência natural e personalizada",
      "Resistentes a manchas de café, vinho e tabaco",
    ],
    faq: [
      { pergunta: "Facetas de porcelana desgastam o dente?", resposta: "Sim, é necessário um desgaste mínimo da superfície do esmalte (cerca de 0,5mm) para que a faceta se integre naturalmente ao sorriso." },
      { pergunta: "Facetas de porcelana mancham?", resposta: "A porcelana é resistente a manchas, mas o cimento na borda pode escurecer com o tempo se a higiene não for adequada." },
      { pergunta: "Qual o valor das facetas de porcelana?", resposta: "O valor por faceta varia de R$ 800 a R$ 2.500, dependendo do material, laboratório e complexidade do caso." },
    ],
    linksExternos: [
      { label: "ABO - Associação Brasileira de Odontologia", url: "https://www.abo.org.br/" },
    ],
  ...
  "Ortodontia (aparelho)": {
    ...
    description: "Coloque aparelho dentário com ortodontistas experientes. Aparelho fixo, móvel, estético e invisível. Compare preços e avaliações.",
    keywords: ["aparelho dentário", "ortodontia", "aparelho ortodôntico", "aparelho estético", "invisalign", "aparelho fixo"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/ortodontia.webp",
    introducao: "A ortodontia é a especialidade que corrige a posição dos dentes e dos ossos maxilares, proporcionando um sorriso alinhado, melhor função mastigatória e prevenindo problemas futuros.",
    topicos: [
  ...
  "Implante dentário": {
    ...
    description: "Recupere seus dentes com implantes dentários. Encontre implantodontistas perto de você, compare preços e veja avaliações reais.",
    keywords: ["implante dentário", "implante dental", "implante de dente", "implante dentário preço", "implantodontista"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/implante-dentario.webp",
    introducao: "O implante dentário é a técnica mais avançada para substituir dentes perdidos. Um pino de titânio é inserido no osso maxilar, funcionando como raiz artificial para receber uma prótese dentária.",
    topicos: [
  ...
  "Tratamento de canal": {
    ...
    description: "Precisa de tratamento de canal? Encontre endodontistas perto de você. Veja preços, avaliações e agende sua consulta sem dor.",
    keywords: ["tratamento de canal", "endodontia", "canal dentário", "extrair canal", "dentista canal"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/implante-dentario.webp",
    introducao: "O tratamento de canal (endodontia) é o procedimento que remove a polpa infectada ou inflamada do interior do dente, limpando, desinfetando e selando o canal radicular para preservar o dente.",
    topicos: [
  ...
  "Prótese dentária": {
    ...
    description: "Recupere seu sorriso com próteses dentárias fixas ou removíveis. Encontre especialistas, compare preços e veja avaliações.",
    keywords: ["prótese dentária", "prótese dental", "prótese fixa", "prótese removível", "dentadura", "coroa dentária"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/implante-dentario.webp",
    introducao: "A prótese dentária é um dispositivo que substitui um ou mais dentes perdidos, restaurando a função mastigatória, a estética do sorriso e prevenindo problemas na articulação temporomandibular.",
    topicos: [
  ...
  "Cirurgia oral": {
    ...
    description: "Precisa de cirurgia oral? Encontre cirurgiões-dentistas perto de você. Extração de siso, dentes inclusos e outros procedimentos cirúrgicos.",
    keywords: ["cirurgia oral", "extração de dente", "cirurgia dentária", "extrair siso", "dente incluso", "cirurgião dentista"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/cirurgia-oral.webp",
    introducao: "A cirurgia oral é a especialidade que realiza procedimentos cirúrgicos na cavidade bucal, como extração de dentes (inclusive sisos inclusos), biópsias, frenectomias e correção de alterações ósseas.",
    topicos: [
  ...
  Periodontia: {
    ...
    description: "Trate doenças da gengiva com periodontistas. Gengivite, periodontite, retração gengival e mau hálito têm solução. Agende sua consulta.",
    keywords: ["periodontia", "doença gengival", "gengivite", "periodontite", "retração gengival", "mau hálito", "tratamento gengiva"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/clinico-geral.webp",
    introducao: "A periodontia é a especialidade que cuida da saúde das gengivas e do osso que suporta os dentes. Previne, diagnostica e trata doenças como gengivite e periodontite, principais causas de perda dentária.",
    topicos: [
  ...
  Odontopediatria: {
    ...
    description: "Leve seu filho ao dentista infantil. Atendimento lúdico e acolhedor para crianças. Prevenção, cárie infantil e orientação para pais.",
    keywords: ["odontopediatria", "dentista infantil", "dentista para crianças", "cárie infantil", "primeira consulta odontopediatria"],
    heroImage: "https://dsnzgxjuqlalysyfiion.supabase.co/storage/v1/object/public/especialidades/cirurgia-oral.webp",
    introducao: "A odontopediatria é a especialidade dedicada à saúde bucal de bebês, crianças e adolescentes. Profissionais treinados para oferecer atendimento acolhedor, lúdico e adaptado a cada fase do desenvolvimento.",
    topicos: [
