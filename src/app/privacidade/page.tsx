...
//
// Conteúdo (LGPD) portado do site-k11, palavra por palavra. Markup e estilos
// inline reproduzidos 1:1 (cores #0A2A66/#3A3A3C/#8E8E93/#007AFF/#34C759, bordas
// 0.5px). A navegação interativa (menu mobile accordion + sidebar com smooth
// scroll) vive em PrivacidadeNav.tsx como Client Component, mantendo esta página
// como Server Component (que exporta metadata).
//
// A retenção de geolocalização do paciente é ZERO na exclusão (expurgo imediato)
// — ver memória [[regua-lembrete-cadastro]] e docs.
//
...
import { MenuMobile, SidebarDesktop } from "./PrivacidadeNav";
