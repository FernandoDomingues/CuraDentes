// ═══════════════════════════════════════════════════════════════════════════════
// COMPONENTE: SEÇÃO APP MOBILE (em breve)
//
...
//
// Esta seção é 100% estática (apenas vitrine), então é um Server Component
// — SEM "use client". Os "botões" de loja são <span> NÃO-clicáveis com badge
// "Em breve" (o app ainda não foi publicado).
// ═══════════════════════════════════════════════════════════════════════════════
      ...
      <div className="container mx-auto px-5 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            {/* Botões App Store / Google Play — NÃO-clicáveis (app em breve).
                Como o app ainda não foi publicado, são <span> sem ação.
                O hover do k11 (onMouseEnter/Leave -> #0d3480) é reproduzido
                aqui com a utilitária hover do Tailwind, sem JS no cliente. */}
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              {["App Store", "Google Play"].map((loja) => (
                <span
                  key={loja}
                  className="flex items-center gap-2.5 px-5 py-3 rounded-[14px] font-semibold text-[14px] min-h-[48px] transition-all duration-200 select-none hover:bg-[#0d3480]"
                  style={{
