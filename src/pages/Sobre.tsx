        ...
        <div className="container mx-auto px-5 md:px-8 lg:px-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a
                href="/pesquisa"
                className="inline-flex items-center px-7 py-3 rounded-[14px] text-white text-[15px] font-semibold transition-all duration-300"
                style={{
                  background: "#007AFF",
                  boxShadow: "0 8px 20px rgba(0,122,255,0.25)",
                }}
                onMouseEnter={(e) => { e.currentTarget.style.background = "#1a8aff"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(0,122,255,0.35)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.background = "#007AFF"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(0,122,255,0.25)"; }}
              >
                Buscar dentista
              </a>
              <a
                ...
                onMouseEnter={(e) => { e.currentTarget.style.background = "#c4003e"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(230,0,76,0.35)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.background = "#E6004C"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(230,0,76,0.28)"; }}
              >
