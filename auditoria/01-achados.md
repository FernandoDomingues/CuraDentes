...
- ✅ **Corrigidos e no ar (~46):** C2, C3, C4, A2, A3, A4, A6, A7, A8, A9, A10, A12, A14, M3, M4, M5, M6, M8, M9, M10, M12, M14, M15, M16, M17, M18, M19, M21, M23, M24, M25, M27, M28, B4, B9, B10, B12, B13, B14, B18, B19. (Inclui também: busca por nome do dentista + autocomplete, e o editor de fotos migrado para `react-easy-crop`.)
- 🟡 **Parciais (parte segura feita, resto precisa de QA/hook):** **A11** (5 `.woff` mortos removidos; falta migrar para `next/font` com QA visual), **A13** (semântica `role="dialog"` feita; falta focus-trap + Esc).
- 🟡 **Abertos e seguros de fazer (sem decisão sua):** M7 (sitemap lastmod — depende da coluna `updated_at`), M11 (estrelas do perfil — visual), M13 (constantes de timeout), M20 (safe-area header), M22 (ARIA combobox — médio), M26 (máscara de telefone), B1, B2, B3, B5, B6 (risco 404), B7, B8, B11 (em AppMobile — seu arquivo), B15.
